...
//        System.out.println("Main.main1: " + Arrays.toString(args));

        List<String> commands = readLines(args[0]);

//        System.out.println("Main.main2: " + commands.size() + ", " + commands);
...
//            System.out.println("Main.main3: " + command);
//            System.out.println("Main.main4: " + Arrays.toString(tokens));
